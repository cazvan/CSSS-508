...
>A integer vector type is returned. This is because R converts the factor vector to an integer vector to preserve information.
...
>It converts the vector to numbers, words, or numbers stored as characters, in that order.

   + What about to character and then numeric?

>Data is converted to NAs

# NO WORK PAST THE FIRST PART OF THIS SECTION
